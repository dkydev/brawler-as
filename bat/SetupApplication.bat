...
:: Android packaging
set AND_CERT_NAME="Untitled"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Untitled.p12
...
set IOS_PROVISION=cert\Untitled.mobileprovision
...
set APP_ID=air.Untitled

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Untitled
